...
type MessageHandler interface {
	ConsumeMessage(ctx context.Context, msg kafkago.Message) *KafkaError
}

// HandlerFunc is a function type that implements MessageHandler.
type HandlerFunc func(ctx context.Context, msg kafkago.Message) *KafkaError
...
func (f HandlerFunc) ConsumeMessage(ctx context.Context, msg kafkago.Message) *KafkaError {
	return f(ctx, msg)
}
